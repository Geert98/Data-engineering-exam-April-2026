...
# 4. trains a baseline Logistic Regression classifier
# 5. evaluates the model on the holdout test period
# 6. saves the trained model, feature list, and metrics
#
...
def train_model(config_path: str = "configs/config.yaml") -> dict:
    ...
    # In this MVP, all selected features are numeric.
    numeric_features = feature_cols

    # Build the preprocessing pipeline for numeric inputs:
    ...
    # Train a Logistic Regression model as the baseline classifier.
    #
    # class_weight="balanced" helps when class distributions are not perfectly equal.
    ...
    # Combine preprocessing and model training into one sklearn pipeline.
